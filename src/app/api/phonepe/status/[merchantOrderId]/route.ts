...
export async function GET(
  ...
  try {
    ...
    // Get payment status from PhonePe using the merchantOrderId (our order ID format: PP-ORD-...)
    // PhonePe expects merchantOrderId in the status endpoint, not their orderId
